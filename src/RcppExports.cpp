...
// computeDiffusion_NR
Eigen::MatrixXd computeDiffusion_NR(double mu_0_, Eigen::VectorXd alpha_, Eigen::VectorXd gamma_, Eigen::VectorXd longLat_, double sigma_, double kappa_, Eigen::MatrixXd coords_, Eigen::MatrixXd X_diffusion_, Eigen::MatrixXd X_reaction_, int rows_, int cols_, Eigen::VectorXi internalPoints_, int nTime_, int diffusionType_, bool dirichlet_, double lengthX_, double lengthY_, bool pad);
RcppExport SEXP _implicit_computeDiffusion_NR(SEXP mu_0_SEXP, SEXP alpha_SEXP, SEXP gamma_SEXP, SEXP longLat_SEXP, SEXP sigma_SEXP, SEXP kappa_SEXP, SEXP coords_SEXP, SEXP X_diffusion_SEXP, SEXP X_reaction_SEXP, SEXP rows_SEXP, SEXP cols_SEXP, SEXP internalPoints_SEXP, SEXP nTime_SEXP, SEXP diffusionType_SEXP, SEXP dirichlet_SEXP, SEXP lengthX_SEXP, SEXP lengthY_SEXP, SEXP padSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type mu_0_(mu_0_SEXP);
    ...
    Rcpp::traits::input_parameter< double >::type lengthY_(lengthY_SEXP);
    Rcpp::traits::input_parameter< bool >::type pad(padSEXP);
    rcpp_result_gen = Rcpp::wrap(computeDiffusion_NR(mu_0_, alpha_, gamma_, longLat_, sigma_, kappa_, coords_, X_diffusion_, X_reaction_, rows_, cols_, internalPoints_, nTime_, diffusionType_, dirichlet_, lengthX_, lengthY_, pad));
    return rcpp_result_gen;
END_RCPP
}
// du_dmu
...
// getPredictions
Rcpp::List getPredictions(double mu_0_, Eigen::VectorXd alpha_, Eigen::VectorXd gamma_, Eigen::VectorXd longLat_, double sigma_, double kappa_, Eigen::VectorXd eta_, Eigen::MatrixXd coords_, Eigen::MatrixXd X_diffusion_, Eigen::MatrixXd X_reaction_, Eigen::MatrixXd X_individual_, Eigen::VectorXi cell_, Eigen::VectorXi positive_, Eigen::VectorXi time_, int rows_, int cols_, int nTime_, int diffusionType_, bool dirichlet_, double lengthX_, double lengthY_, bool pad);
RcppExport SEXP _implicit_getPredictions(SEXP mu_0_SEXP, SEXP alpha_SEXP, SEXP gamma_SEXP, SEXP longLat_SEXP, SEXP sigma_SEXP, SEXP kappa_SEXP, SEXP eta_SEXP, SEXP coords_SEXP, SEXP X_diffusion_SEXP, SEXP X_reaction_SEXP, SEXP X_individual_SEXP, SEXP cell_SEXP, SEXP positive_SEXP, SEXP time_SEXP, SEXP rows_SEXP, SEXP cols_SEXP, SEXP nTime_SEXP, SEXP diffusionType_SEXP, SEXP dirichlet_SEXP, SEXP lengthX_SEXP, SEXP lengthY_SEXP, SEXP padSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type mu_0_(mu_0_SEXP);
    ...
    Rcpp::traits::input_parameter< double >::type lengthY_(lengthY_SEXP);
    Rcpp::traits::input_parameter< bool >::type pad(padSEXP);
    rcpp_result_gen = Rcpp::wrap(getPredictions(mu_0_, alpha_, gamma_, longLat_, sigma_, kappa_, eta_, coords_, X_diffusion_, X_reaction_, X_individual_, cell_, positive_, time_, rows_, cols_, nTime_, diffusionType_, dirichlet_, lengthX_, lengthY_, pad));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_implicit_computeDiffusion_NR", (DL_FUNC) &_implicit_computeDiffusion_NR, 18},
    ...
    {"_implicit_getPredictions", (DL_FUNC) &_implicit_getPredictions, 22},
    {NULL, NULL, 0}
};
